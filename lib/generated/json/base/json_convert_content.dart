...
class JsonConvert {
	static final Map<String, JsonConvertFunction> convertFuncMap = {
		...
		(ArticleListDatasTags).toString(): ArticleListDatasTags.fromJson,
...
List<T>? convertListNotNull<T>(dynamic value, {EnumConvertFunction? enumConvert}) {
  ...
  T? _asT<T extends Object?>(dynamic value,
	...
	static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
		...
		if(<ArticleListDatasTags>[] is M){
			return data.map<ArticleListDatasTags>((Map<String, dynamic> e) => ArticleListDatasTags.fromJson(e)).toList() as M;
		}
		if(<BannerHomeEntity>[] is M){
			return data.map<BannerHomeEntity>((Map<String, dynamic> e) => BannerHomeEntity.fromJson(e)).toList() as M;
		}
